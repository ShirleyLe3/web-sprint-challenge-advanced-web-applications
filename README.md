...
token is used to assign a number to each login. once the token is recognized, the user is logged onto the page (ie, BubblePage)

2. What steps can you take in your web apps to keep your data secure?
   this video was sponsored by NORDVPN
   encrpt your data, scan regularly, virus protection, seecurity platformsuch as WebARX
3. Describe how web servers work.
   web servers communicate between user and server through HTTP; it stores and process weppages and handles network requests

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
   Create (PUT, POST), Read (GET), Edit (PUT), and Delete(DELETE) are methods that are used to update and replace existing code.
